<div class="container">
      ...
      <div class="card mb-3">
        <div class="row no-gutters">
          <div class="col-md-4">
            ...
            <p class="card-text mr-3"><div class="g-ytsubscribe mr-5" data-channelid="UC5KW9VowHehb_jHAhDMZpEQ" data-layout="full" data-count="default"></div> </p>
  ...
  <div class="row mb-5 mt-3">
    <div class="col-md-12">
      <h3>Kumpulan Video Ustadz <?=  $channelName; ?></h3>
      <hr>
    </div>
